export const messages = {
  'zh-CN': {
    ...
    home: {
      ...
      queueTitle: '队列与结果',
      queueSubtitle: '所有文件会按状态分区显示，支持重试、移除、下载和复制服务端结果链接。',
  ...
  'en-US': {
    ...
    home: {
      ...
      queueSubtitle: 'Files are grouped by status and stay actionable with retry, remove, download, and server-link copy controls.',
